...
<html lang="en">
<head>
<title>@if($allsettings->site_blog_display == 1) {{ $edit['post']->post_title }} @else {{ Helper::translation(3846,$translate) }} @endif - {{ $allsettings->site_title }}</title>
@include('meta')
@include('style')
</head>
<body>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ Helper::translation(3867,$translate) }}</li>
            </ol>
          </nav>
        </div>
      ...
      <div class="row pt-5 mt-md-2">
        <section class="col-lg-8">
          ...
          <div class="d-flex flex-wrap justify-content-between pt-2 pb-4 mb-1">
            <div class="mt-3"><span class="d-inline-block align-middle text-muted font-size-sm mr-3 mb-2">{{ Helper::translation(4560,$translate) }}</span>
              ...
              <div class="card-body">
                ...
                <form class="media-body needs-validation ml-3" action="{{ route('single') }}" method="post" novalidate>
                    ...
                    <div class="form-group">
                      <textarea class="form-control" rows="4" placeholder="{{ Helper::translation(4254,$translate) }}" name="comment_content" required></textarea>
          ...
          <div class="cz-sidebar border-left ml-lg-auto" id="blog-sidebar">
            ...
            <div class="cz-sidebar-body py-lg-1" data-simplebar data-simplebar-auto-hide="true">
              ...
              <div class="widget mb-grid-gutter pb-grid-gutter border-bottom">
                <h3 class="widget-title">{{ Helper::translation(3873,$translate) }}</h3>
              ...
              <div class="widget mb-grid-gutter">
                <h3 class="widget-title">{{ Helper::translation(4494,$translate) }}</h3>
