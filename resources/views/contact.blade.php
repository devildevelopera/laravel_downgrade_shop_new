      ...
      <div class="row">
        <div class="col-lg-5 px-4 px-xl-5 py-5">
          ...
          @csrf
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="from_name" data-bvalidator="required">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="form-group">
              <label for="cf-message">{{ Helper::translation(4008,$translate) }} <span class="text-danger">*</span></label>
              {!! app('captcha')->display() !!}
