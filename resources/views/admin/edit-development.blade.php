                                    ...
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['brand']->logo_status == 1) selected @endif>Active</option>
                                                <option value="0" @if($edit['brand']->logo_status == 0) selected @endif>InActive</option>
                                                </select>
