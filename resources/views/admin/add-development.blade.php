                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.add-development') }}" method="post" id="setting_form" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1">Logo (size 200 x 200)</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="logo_order" name="logo_order" type="text" class="form-control" data-bvalidator="digit,min[0]">
                                            </div> 
